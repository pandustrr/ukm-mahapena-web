        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-slate-600 dark:text-slate-300 text-lg max-w-2xl mx-auto">
              Koleksi artikel dan berita terbaru dari UKM Mahapena-FEB UNEJ
            </p>
          </div>
          ...
          {loading ? (
            ...
            <div className="text-center py-16">
              ...
              <h4 className="text-lg font-medium text-slate-500 dark:text-slate-400 mb-2">
                Belum Ada Artikel
              </h4>
                  ...
                  >
                    ...
                    <div className="p-3 md:p-4 lg:p-6">
                      ...
                      >
                        ...
                        <svg
                          className="w-3 h-3 md:w-4 md:h-4 transition-transform group-hover/link:translate-x-1"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
